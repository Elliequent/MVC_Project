...
namespace Local_Theatre_Company_V1._0.Controllers
{
    ...
    /// <summary>
    /// Account Controller
    /// Not written or developed by myself
    /// Auto generated with Visual Studio
    /// Alterations made to password requirements and user registeration
    /// </summary>
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Adding newly signup user to customer role
